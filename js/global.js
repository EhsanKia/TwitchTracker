...
function() {
    ...
    function p(n) {
        return n.type == "keypress" ? String.fromCharCode(n.which) : e[n.which] ? e[n.which] : t[n.which] ? t[n.which] : String.fromCharCode(n.which).toLowerCase()
    }
    ...
    function b(e, t) {
        ...
        for (r = 0; r < n.length; ++r) {
            if (n[r].seq) {
                s = !0, i[n[r].seq] = 1, y(n[r].callback, t, n[r].combo);
                continue
            }!s && !l && y(n[r].callback, t, n[r].combo)
        }
        t.type == l && !E(e) && v(i)
    }
    ...
    function N(e, t, n, r) {
        ...
        var i = function(t) {
            ...
            o;
        for (o = 0; o < t.length; ++o) C(t[o], o < t.length - 1 ? i : s, r, e, o)
    }

    function C(e, t, i, o, u) {
        e = e.replace(/\s+/g, " ");
        var a = e.split(" "),
            f, l, c, h = [];
        if (a.length > 1) {
        ...
        c = e === "+" ? ["+"] : e.split("+");
        for (f = 0; f < c.length; ++f) l = c[f], r[l] && (l = r[l]), i && i != "keypress" && n[l] && (l = n[l], h.push("shift")), E(l) && h.push(l);
        i = T(l, h, i), s[l] || (s[l] = []), m(l, h, {
            type: i
        }, !o, e), s[l][o ? "unshift" : "push"]({
            callback: t,
            modifiers: h,
            action: i,
            seq: o,
    ...
    var e = {
        ...
        a, f = !1,
        l = !1;
    for (var c = 1; c < 20; ++c) e[111 + c] = "f" + c;
    for (c = 0; c <= 9; ++c) e[c + 96] = c;
    h(document, "keypress", w), h(document, "keydown", w), h(document, "keyup", w);
    var L = {
        bind: function(e, t, n) {
            return k(e instanceof Array ? e : [e], t, n), o[e + ":" + n] = t, this
        },
        unbind: function(e, t) {
            return o[e + ":" + t] && (delete o[e + ":" + t], this.bind(e, function() {}, t)), this
        },
        trigger: function(e, t) {
            return o[e + ":" + t](), this
        },
    ...
    window.Mousetrap = L, typeof define == "function" && define.amd && define("mousetrap", function() {
        return L
    })
}(),
function(e, t, n) {
...
function(e, t) {
    ...
    function r(e, t) {
        return this instanceof r ? (e === undefined && (typeof location != "undefined" ? e = location.href + "" : e = ""), this.href(e), t !== undefined ? this
            .absoluteTo(t) : this) : new r(e, t)
    }
...
googletag.cmd = googletag.cmd || [],
    ...
    function(e) {
        window.initializeLegacyColumns = function(t) {
            ...
            e(window).on("fluid-resize", function() {
                ...
                e.preventDefault(), s()
            }), Mousetrap.bind("alt+l", n), Mousetrap.bind("alt+r", s), e(".stretch").each(function() {
    ...
    function(e) {
        var t = {
            follow: function(t, n) {
                this.each(function() {
                    var r = e(this);
                    r.click(function(i) {
                        i.preventDefault(), Twitch.user.isLoggedIn() ? (t && t(), Twitch.api.put("users/:login/follows/channels/" + r.attr("channel"), {
                            src: r.attr("src")
                        }).fail(n || null)) : e.login({
            ...
            unfollow: function(t, n) {
                this.each(function() {
                    var r = e(this);
                    r.click(function(e) {
                        e.preventDefault(), Twitch.user.isLoggedIn() && (t && t(), Twitch.api.del("users/:login/follows/channels/" + r.attr("channel"), {
                            src: r.attr("src")
                        }).fail(n || null))
                    })
                })
        ...
        e.fn.followbutton = function(n) {
            n = e.extend({
                method: "follow",
                success: undefined,
                error: undefined
            }, n);
            if (!t[n.method]) throw new Error("No method with name: " + n.method);
            t[n.method].call(this, n.success, n.error)
        }
    }(jQuery),
    function(e) {
        ...
        var n = {
            ...
            getSessionStorage: function() {
                if (this._sessionStorage === null) try {
                    ...
                    var t = _sessionStorage.getItem(e) != e;
    ...
    function(e, t) {
        ...
        n.init = function(e) {
        ...
        }, n._ajax = function(o, u, a, f) {
            var l = new t.Deferred,
                c, h;
            f = t.extend({}, f), f.headers = f.headers || {}, f.headers["Client-ID"] = f.headers["Client-ID"] || r, a || (a = {}), a.on_site = "1", o !== "GET" && o !== "POST" ? (f.type = "POST", f.headers["X-Http-Method-Override"] = o) : f.type = o;
            var p = f.version || f.v || s;
            f.headers.Accept = "application/vnd.twitchtv.v" + p + "+json", f.headers.Authorization ? (f.secure = !0, f.allow_cookie = !1, delete a.on_site) : (c = e.storage.legacy.get("api_token"), c && (f.headers["Twitch-Api-Token"] = c), f.allow_cookie = !0), /^(\/kraken\/)?streams(?!\/summary\/*$|\/featured\/*$|\/communities\/)/.test(u) && (f.use_streams_api = !0, f.allow_cookie = !1), f.success && l.done(f.success), f.error && l.fail(f.error), h = t.extend({}, f, {
                url: this._constructUrl(u, f),
                dataType: "json",
                cache: !0,
                global: !1,
                data: a,
            ...
            if (f.use_streams_api || f.secure && window.location.protocol.slice(0, 5) !== "https")
                if (this._canCORS()) h.xhrFields.withCredentials = f.allow_cookie;
                else {
                    h.dataType = "jsonp", h.headers && h.headers["Client-ID"] && (h.data.client_id = h.headers["Client-ID"], delete h.headers["Client-ID"]);
                    if (h.headers && h.headers.Authorization) {
                        var d = /^OAuth:?\s+(\w+)$/.exec(h.headers.Authorization);
                        d && (h.data.oauth_token = d[1], delete h.headers.Authorization)
                    }
                }
            else h.beforeSend = this._beforeSend;
            return l.fail(function(e, t, r) {
                n.trigger("fail", {
                    url: h.url,
                    jqXHR: e,
                    textStatus: t,
            ...
            }), n.isIframeReady ? t.ajax(h) : i.push(h), l.promise()
    ...
    function(e, t) {
        function r() {
            ...
            return n = (new RSVP.Promise(function(t, n) {
                ...
                throw e.status === 401 && (cookie.remove("login"), cookie.remove("name")), e
            }), n
        }
        ...
        i.login = function() {
            ...
            return cookie.get("api_token") ? cookie.get("name") : null
        }, i.isLoggedIn = function() {
            return cookie.get("api_token") ? !!cookie.get("login") : !1
        }, i.reset = function() {
            n = undefined
        };
        var s = "Deprecation warning: Use Twitch.user() instead";
        i.userId = function() {
            return console.debug(s), PP.user_id
        }, e.mixin({
            user: i
        })
    }(Twitch, jQuery),
    function(e, t) {
        var n = {
                ...
                csGoSkillImg: "http://media.steampowered.com/apps/csgo/images/skillgroups/skillgroup:1.png"
            },
            r = function(e, t) {
...
function(e, t) {
    var n = SiteOptions.experiments || {},
        r = {
            ...
            VOD_COVIEWS_USER_RECS: "58a07c08-c495-4f64-96ae-d29bc623a58b",
        ...
        i = {
            ...
            "58a07c08-c495-4f64-96ae-d29bc623a58b": "control",
...
function(e, t) {
    ...
    n.ready =
        function(t) {
            ...
            return n._readyData ? n._readyData.enabled : (o(), !PP.turbo && !PP.activeChannelSubscriber && (!PP.login || PP.login !== PP.channel))
        }, n.fetchAll = function() {
...
function(e, t) {
    window.lrAdImpression || (window.lrAdImpression = function(t) {
        t = t || {}, e.ads.lastLiverailAdId = ["connectionID=" + t.connectionID, "creativeID=" + t.creativeID, "id=" + t.id].join("&")
    })
}(Twitch, jQuery),
function(e, t) {
    var n = {
...
(function(e, t) {
    ...
    function(e, t) {
        var n = {},
            ...
            s = function(t, n, s) {
                if (r) return;
                n = n || {}, n.distinct_id || (n.distinct_id = e.idsForMixpanel.getOrCreateUniqueId()), n.device_id = e.idsForMixpanel.getOrCreateUniqueId(), e.geo.then(function(r) {
                    n = _.extend({
        ...
        if (window.history && typeof window.history.replaceState == "function") {
            var a = (new URI).removeQuery("tt_medium").removeQuery("tt_content").removeQuery("followed_flow");
        ...
        n.funnel = {
            ...
            handleCampaignClick: function(r) {
                ...
                if (i.length) {
                    ...
                    if (i.attr("data-ember-action")) e.tracking.funnel.addProperties(s);
                    else if (i.prop("tagName").toLowerCase() === "a") {
                        var o = i.attr("href") || "";
                        i.attr("href", URI(o).addSearch({
    ...
    function(e) {
        ...
        window.euCookieNotification = function() {
            ...
            t || e.notify.alert(i18n("This site uses cookies. By continuing to browse the site, you are agreeing to our use of cookies. Review our <a href='/user/legal?page=cookie_policy'>Cookie Policy</a> for more details."), {
                layout: "bottomCenter",
                timeout: !1,
                escape: !1
            }, function() {
